...
class AutoHubConnection {
    ...
    invoke(methodName, ...args) {
        return signalr_1.HubConnection.prototype.invoke.apply(this.connection, arguments);
    }
    ...
    send(methodName, ...args) {
        return signalr_1.HubConnection.prototype.send.apply(this.connection, arguments);
    }
    ...
    stream(methodName, ...args) {
        return signalr_1.HubConnection.prototype.stream.apply(this.connection, arguments);
    }
            ...
            if (this.connectionPromise === null) {
                try {
                    ...
                    this.connectionPromise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        yield this.connect(resolve, reject, 0);
                    }));
                }
                catch (_a) {
                    if (this.connection) {
    ...
    get state() {
        ...
        return signalr_1.HubConnectionState.Disconnected;
    }
    connect(resolve, reject, attemptCount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
...
exports.AutoHubConnection = AutoHubConnection;
